...
const services = [
  {
    title: "Gel Manicure",
    description:
      "Includes cuticle prep, shaping, and gel polish application",
    price: "$40",
  },
  {
    title: "Acrylic Full Set",
    description:
      "Full sculpted acrylic set with shaping and your choice of color",
    price: "$65",
  },
  {
    title: "Acrylic Refill",
    description:
      "Fill-in for existing acrylic set with reshaping and polish",
    price: "$50",
  },
];
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mt-16">
        {services.map((service, index) => (
          <div key={index} className="group w-72 h-96 [perspective:1200px]">
<div className="relative w-full h-full transition-transform duration-[1300ms] ease-[cubic-bezier(0.25,0.8,0.25,1)] shadow-[0_25px_60px_rgba(0,0,0,0.5)] [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
              {/* FRONT */}
              <div className="absolute inset-0 [backface-visibility:hidden] [transform:translateZ(10px)]">
                <div className="relative w-full h-full rounded-2xl border-[3px] border-[#c6a53a] shadow-lg overflow-hidden">
                  ...
                  <div className="relative z-10 h-full flex items-center justify-center text-white">
                    <span className="text-2xl font-semibold text-center px-4">
                      {service.title}
                    </span>
                  </div>
